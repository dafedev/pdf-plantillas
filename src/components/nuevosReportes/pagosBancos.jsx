...
const MyDocument = ({ selectedOption, info }) => {
  ...
  if (render === 1) {
    return <ReporteComision info={info} />;
  }
  if (render === 2) {
    return <ReporteFecha info={info} />;
  }
};

const ReporteFecha = ({ info }) => {
        ...
        <Document>
          <Page size="A4" style={styles.page}>
            ...
            {data.map((item, index) => (
              <>
                <Text
                  style={[styles.bold, styles.underline, { marginBottom: 10 }]}
                >
